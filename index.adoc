...
// markup not found, no include::{specDir}gadgets/external/POST/spec.adoc[opts=optional]
...
| 204
| Provided gadget link was null or empty. Operation is skipped
|  <<>>
...
// markup not found, no include::{snippetDir}gadgets/external/POST/http-request.adoc[opts=optional]


// markup not found, no include::{snippetDir}gadgets/external/POST/http-response.adoc[opts=optional]



// file not found, no * wiremock data link :gadgets/external/POST/POST.json[]


ifdef::internal-generation[]
===== Implementation

// markup not found, no include::{specDir}gadgets/external/POST/implementation.adoc[opts=optional]
...
// markup not found, no include::{specDir}gadgets/external/GET/spec.adoc[opts=optional]
...
// markup not found, no include::{snippetDir}gadgets/external/GET/http-request.adoc[opts=optional]


// markup not found, no include::{snippetDir}gadgets/external/GET/http-response.adoc[opts=optional]



// file not found, no * wiremock data link :gadgets/external/GET/GET.json[]


ifdef::internal-generation[]
===== Implementation

// markup not found, no include::{specDir}gadgets/external/GET/implementation.adoc[opts=optional]
